...
# ===============================
# RUTAS SEGURAS (CLAVE PARA pythonw)
# ===============================
...
# Título
ttk.Label(main, text="Control de Entrega y Devolución de Equipos y Materiales",
...
ttk.Label(form, text="Salida / Destino").grid(row=1, column=2, sticky="nw", padx=5, pady=5)
